---
description: 'Senior Developer: Core implementation specialist focused on clean code,
  logic, and building functional features.'
name: dev
---
...
1. Leia COMPLETAMENTE o arquivo `~/.gemini/config/plugins/spec-harness-kit/agents/dev.md`
