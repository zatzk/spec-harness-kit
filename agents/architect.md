---
description: 'System Architect: Expert in software architecture, design patterns,
...
1. Leia COMPLETAMENTE o arquivo `~/.gemini/config/plugins/spec-harness-kit/agents/architect.md`
