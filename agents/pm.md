---
description: 'Product Manager: Focused on product strategy, feature prioritization,
  roadmap planning, and user value.'
name: pm
---
...
1. Leia COMPLETAMENTE o arquivo `~/.gemini/config/plugins/spec-harness-kit/agents/pm.md`
