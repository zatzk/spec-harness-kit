---
description: 'DevOps Engineer: Expert in CI/CD pipelines, repository management, infrastructure-as-code,
...
1. Leia COMPLETAMENTE o arquivo `~/.gemini/config/plugins/spec-harness-kit/agents/devops.md`
