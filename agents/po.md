---
description: 'Product Owner: Technical specialist in backlog management, story refinement,
  and defining clear acceptance criteria.'
name: po
---
...
1. Leia COMPLETAMENTE o arquivo `~/.gemini/config/plugins/spec-harness-kit/agents/po.md`
